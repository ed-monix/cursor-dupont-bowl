...
def test_cli_run_sheet_says_dispatch(capsys):
    ...
    assert "GitHub connector" in out


def test_create_instructions_use_github_connector():
    roster = grok_bots.load_roster(REPO)
